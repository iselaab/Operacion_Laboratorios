<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Objetivo.aspx.cs" Inherits="OperacionLaboratorios.Objetivo" %>
...
<body>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link disabled" href="Objetivo.aspx">Objetivo </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="container">
            ...
            <hr />
            <p class="text-center">
                Documentar la instruccion de trabajo que asegure la calidad del proceso de operacion
                de laboratorios, de tal manera que se cumpla con la carta descriptiva de la academia 
                y del programa académico, satisfaciendo aspi los conocimientoes requeridos para el Estudiante.
            </p>
        </div>
    </form>
