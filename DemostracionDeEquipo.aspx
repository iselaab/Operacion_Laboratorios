<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemostracionDeEquipo.aspx.cs" Inherits="OperacionLaboratorios.DemostracionDeEquipo" %>
      ...
      <li class="nav-item">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="container text-center">
            <h1>Demostració del equipo</h1>
            <hr />
            <div class="jumbotron jumbotron-fluid">
            <asp:FileUpload ID="FileUpload1" runat="server" />
            <br />
            <asp:Button class="btn btn-success" style="margin-top:30px;" ID="Button2" runat="server" OnClick="Button2_Click" Text="Subir archivo" />
            <br />
            <br />
